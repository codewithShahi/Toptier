...
const HotelDetails = () => {
  ...
  const checkinDefault = formatDate(
  ...
  const checkoutDefault = formatDate(
  ...
  // Sample images array - add your actual images here
  const images = [
    "/images/auth_bg.jpg",
    "/images/auth_bg.jpg",
    "/images/auth_bg.jpg",
  ...
  return (
    <div className="bg-[#F9FAFB] font-medium">
      <div className="appHorizantalSpacing max-w-[1200px] mx-auto py-5">
      <section className="hotel-search">
        <form
          onSubmit={handleSubmit}
          className="grid grid-cols-12 w-full gap-3 py-10"
        >
            ...
            <div className="grid grid-cols-12 w-full gap-3">
              ...
              <div className="lg:col-span-3 md:col-span-6 col-span-12">
                <div className="flex flex-col gap-y-3">
                  <p className="text-[15.18px] font-[500] text-[#5B697E]">
                    Where to?
                  </p>
                  <div className="flex items-center px-3 gap-2 border-[0.99px] border-[#E3E7EB] rounded-[12.29px] w-full h-[44px]">
                    
<svg width="16" height="19" viewBox="0 0 16 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.14827 17.2589C8.00048 17.3648 7.82311 17.4218 7.64115 17.4218C7.4592 17.4218 7.28183 17.3648 7.13403 17.2589C2.76106 14.1483 -1.87996 7.75019 2.81177 3.12689C4.0998 1.86249 5.8344 1.15424 7.64115 1.15503C9.45228 1.15503 11.1901 1.86443 12.4705 3.12599C17.1623 7.74929 12.5212 14.1465 8.14827 17.2589Z" stroke="#5B697E" stroke-opacity="0.7" stroke-width="1.35554" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7.64072 9.28836C8.12106 9.28836 8.58173 9.09794 8.92138 8.75899C9.26104 8.42004 9.45185 7.96032 9.45185 7.48097C9.45185 7.00162 9.26104 6.54191 8.92138 6.20296C8.58173 5.86401 8.12106 5.67358 7.64072 5.67358C7.16038 5.67358 6.69971 5.86401 6.36006 6.20296C6.02041 6.54191 5.82959 7.00162 5.82959 7.48097C5.82959 7.96032 6.02041 8.42004 6.36006 8.75899C6.69971 9.09794 7.16038 9.28836 7.64072 9.28836Z" stroke="#5B697E" stroke-opacity="0.7" stroke-width="1.35554" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
      ...
      className="w-full text-[14.83px] font-[500] placeholder:text-[#0F172B] 
                 focus:outline-none autofill:bg-transparent autofill:text-[#0F172B]"
    ...
    />
              ...
              <div className="lg:col-span-3 md:col-span-6 col-span-12">
                <div className="flex flex-col gap-y-3">
                  ...
                  <DatePicker
                    ...
                    className="w-full h-[44px] font-medium pl-1 text-sm placeholder-gray-400 border border-gray-200 rounded-xl text-gray-900 bg-white transition-all duration-200 focus:outline-none"
                    onSelect={(date) => {
                      setForm({
                        ...form,
              ...
              <div className="lg:col-span-3 md:col-span-6 col-span-12">
                <div className="flex flex-col gap-y-3">
                  ...
                  <div className="flex justify-between items-center px-3 gap-2 w-full h-[44px] font-medium pl-3 placeholder-gray-400 border border-gray-200 rounded-xl text-gray-900 text-[14.83px] bg-white transition-all duration-200 focus:outline-none">                  
  <div className="flex items-center gap-3">
    <svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6.77968 6.94058C8.41733 6.94058 9.74491 5.61301 9.74491 3.97536C9.74491 2.33771 8.41733 1.01013 6.77968 1.01013C5.14203 1.01013 3.81445 2.33771 3.81445 3.97536C3.81445 5.61301 5.14203 6.94058 6.77968 6.94058Z" stroke="#8C96A5" stroke-width="1.11196"/>
    <path d="M12.7105 12.5004C12.7105 14.3425 12.7105 15.8362 6.78006 15.8362C0.849609 15.8362 0.849609 14.3425 0.849609 12.5004C0.849609 10.6582 3.50497 9.16449 6.78006 9.16449C10.0552 9.16449 12.7105 10.6582 12.7105 12.5004Z" stroke="#8C96A5" stroke-width="1.11196"/>
  </svg>
...
<path d="M12.9463 0.19699L14.0128 1.21205L8.20043 6.74081C8.1073 6.82993 7.99655 6.90066 7.87455 6.94892C7.75256 6.99719 7.62174 7.02203 7.4896 7.02203C7.35747 7.02203 7.22665 6.99719 7.10466 6.94892C6.98266 6.90066 6.87191 6.82993 6.77878 6.74081L0.963379 1.21205L2.02987 0.197947L7.4881 5.38708L12.9463 0.19699Z" fill="#0F172B"/>
</svg>
</div>
          ...
          {/* Submit */}
          <div className="lg:col-span-2 col-span-12 flex flex-col justify-end">
            <button
              type="submit"
              className="bg-[#163C8C] h-[44px] text-white rounded-lg px-4 flex items-center gap-3 py-2 transition"
            >
                
<svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.7324 13.5786L15.5913 16.4375M14.6881 8.5478C14.6881 10.3941 13.9547 12.1648 12.6492 13.4703C11.3436 14.7759 9.57294 15.5093 7.72663 15.5093C5.88033 15.5093 4.10965 14.7759 2.80411 13.4703C1.49858 12.1648 0.765137 10.3941 0.765137 8.5478C0.765137 6.7015 1.49858 4.93081 2.80411 3.62528C4.10965 2.31975 5.88033 1.5863 7.72663 1.5863C9.57294 1.5863 11.3436 2.31975 12.6492 3.62528C13.9547 4.93081 14.6881 6.7015 14.6881 8.5478Z" stroke="white" stroke-width="1.3923" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
              <span className="text-[15.78px] font-[500] pt-1">Search Homes</span>
            </button>
          </div>
        </form>
      </section>
      ...
      <section className="image-slider py-3">
        <div className="relative max-w-[920px] overflow-hidden">
          {/* Image Container */}
          <div 
            className="flex transition-transform duration-300 ease-in-out gap-4"
            style={{ 
              transform: `translateX(-${currentSlide * 380}px)`,
              width: `${images.length * 380}px`
            }}
          >
            {images.map((image, index) => (
              <div key={index} className="w-[360px] h-[324px] flex-shrink-0">
                <img 
                  className="rounded-[33.16px] w-full h-full object-cover" 
                  src={image}  
        ...
        <div className="flex justify-between mt-4">
          <button 
            ...
            className={`p-2 rounded-full transition-opacity ${
              currentSlide === 0 ? 'opacity-50 cursor-not-allowed' : 'opacity-100 hover:bg-gray-100'
            }`}
          >
            <svg
              width="14"
            ...
            >
              <path
                d="M13.666 5.83724H3.52427L6.50768 8.82891L5.33268 10.0039L1.03982 5.71101C0.649298 5.32049 0.649298 4.68732 1.03982 4.2968L5.33268 0.00390625L6.50768 1.17891L3.52427 4.17057H13.666V5.83724Z"
                fill="#0F1112"
              />
            </svg>
          </button>
          ...
          <button 
            onClick={nextSlide}
            disabled={currentSlide >= images.length - 3}
            className={`p-2 rounded-full transition-opacity ${
              currentSlide >= images.length - 3 ? 'opacity-50 cursor-not-allowed' : 'opacity-100 hover:bg-gray-100'
            }`}
          >
      ...
      <section className="manor&spa py-4">
...
<path d="M8.77051 12.5737L12.8652 8.479" stroke="#112233" stroke-opacity="0.9" stroke-width="1.70611" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <section className="choose-your-room py-4">
