...
const HotelCard = memo(function HotelCard({
  ...
  return (
    ...
    >
     ...
     <div className={`p-3 min-w-0 ${viewMode === 'list' ? 'flex-1 flex flex-col justify-between' : ''}`}>

        <div>
          <h3
            className="text-xl font-extrabold text-gray-900 mb-4 pl-4 sm:text-2xl md:text-xl lg:text-2xl text-ellipsis truncate whitespace-nowrap"
