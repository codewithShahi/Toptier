...
export default function BookingDetails() {
  ...
  return (
    <section className="bg-[#F9FAFB] w-full min-h-screen">
    <div className="max-w-[1200px] mx-auto px-4 md:px-6 flex flex-col md:flex-row py-10 mb-6 gap-8">
      {/* form  */}
            ...
            <div className="w-full max-w-sm ">
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder=" "
                  className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-lg outline-none"
                  autoComplete="off"
                />
                <label
                  htmlFor="firstname"
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="w-full max-w-sm ">
            <div className="relative">
              <input
                ...
                type="email"
                placeholder=" "
                className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-lg outline-none mb-2"
                autoComplete="off"
              />
              <label
                htmlFor="email"
          ...
          <div className="flex gap-4">
            ...
            <div className="">
              ...
              <div className="w-full max-w-32 relative" ref={dropdownRef}>
                <input
                  id="countrynumber"
                  type="tel"
                  placeholder=" "
                  ...
                  className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-32 outline-none mb-2 [appearance:textfield]"
                  autoComplete="off"
                />
                <label
            ...
            <div className="w-full max-w-sm">
              <div className="relative">
                <input
                  ...
                  type="tel"
                  placeholder=" "
                  className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-64 outline-none mb-2 [appearance:textfield]"
                  autoComplete="off"
                />
                <label
                  htmlFor="number"
          ...
          <div className="w-full max-w-sm ">
            <div className="relative">
              <input
                ...
                type="number"
                placeholder=" "
                className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-lg outline-none mb-2 [appearance:textfield]
              ...
              {/* card svgs  */}
                 <div className="flex gap-4 relative bottom-12 left-93">
                <svg
                  width="30"
                  height="19"
                  viewBox="0 0 30 19"
            ...
            <div className="w-full max-w-62 ">
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder=" "
                  className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-62 outline-none mb-2"
                  autoComplete="off"
                />
                <label
                  htmlFor="expiration"
            ...
            <div className="w-full max-w-62 ">
              <div className="relative">
                <input
                  ...
                  type="number"
                  placeholder=" "
                  className="peer block border border-gray-300 rounded-xl px-3 pt-4 pb-4 text-base w-62 outline-none mb-2 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none
                  [&::-webkit-inner-spin-button]:appearance-none"
                  autoComplete="off"
                />
                <label
