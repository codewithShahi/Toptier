...
export const RoomCard = ({ room, getAmenityIcon }: RoomCardProps) => {
  ...
  return (
        ...
        <div className="w-full rounded-[45px] bg-[#FFFFFF] p-2 border border-[#E0E0E0]">
          <div className="relative h-[260px] w-full rounded-4xl overflow-hidden">
            <img
          ...
          <div className="flex flex-col gap-1 p-3">
            <h1 className="text-xl text-[#0F172B] font-[800]">{room.name}</h1>

            {/* Rating - you can add real data later */}
            ...
            <div className="flex gap-2 mt-2">
              ...
              <button className="bg-[#EBEFF4] cursor-pointer rounded-full p-2">
