...
const TestimonialSection = () => {
  ...
  const renderStars = (rating: number) => {
    const rounded = Math.round(rating); // ratings are strings like "5.00"
        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div
              ...
              style={{
                transform: `translateX(-${currentIndex * (typeof window !== "undefined" && window.innerWidth < 640 ? 100 : 60)}%)`
              }}
            >
                ...
                >
                  <div className="bg-[#F8F9FA] rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 min-h-[350px] sm:h-[390px] relative overflow-hidden border border-gray-100">
                    ...
                    <div className="block sm:hidden">
                      ...
                      <p
                        className="text-[#4B5154] text-base leading-relaxed mb-4"
                    ...
                    <div className="hidden sm:block">
                      <div className="w-[60%] pr-4">
                        ...
                        <p
                          className="text-[#4B5154] text-base sm:text-lg leading-relaxed line-clamp-3 w-[95%] sm:w-[80%]"
                          dangerouslySetInnerHTML={{ __html: testimonial.description }}
                        />
                      </div>
                    </div>
