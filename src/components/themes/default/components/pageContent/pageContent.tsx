      ...
      <div className="bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 px-6 py-7 rounded-lg mt-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Button
            ...
            className="flex gap-1 w-auto transition-colors duration-400 ease-in-out text-white bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 items-center justify-center rounded-lg text-sm font-medium border-none outline-none focus:outline-none min-w-fit"
          >
